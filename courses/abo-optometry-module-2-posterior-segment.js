class AboOptometryModule2PosteriorSegment extends HTMLElement {
    connectedCallback() {
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        .wrapper { font-family: var(--font-body); background: var(--bg-primary); color: var(--text-secondary); line-height: 1.7; max-width: 100vw; overflow-x: hidden; }
        .header { background: var(--bg-secondary); border-bottom: 1px solid var(--border-color); padding: 1rem 1.5rem; position: sticky; top: 0; z-index: 100; width: 100%; max-width: 100vw; overflow: hidden; }
        .header-content { max-width: 1100px; margin: 0 auto; display: flex; align-items: center; justify-content: space-between; gap: 1rem; flex-wrap: wrap; width: 100%; }
        ...
        .hero { background: linear-gradient(135deg, var(--bg-secondary) 0%, var(--bg-primary) 100%); border-bottom: 1px solid var(--border-color); padding: 2.5rem 1.5rem; position: relative; overflow: hidden; width: 100%; max-width: 100vw; }
        ...
        .hero-content { position: relative; max-width: 900px; margin: 0 auto; text-align: center; width: 100%; }
        ...
        main { max-width: 900px; margin: 0 auto; padding: 2rem 1.5rem 4rem; width: 100%; }
        .topic-content { display: none; width: 100%; max-width: 100%; }
        .topic-content.active { display: block; animation: fadeIn 0.3s ease; }
        @keyframes fadeIn { from { opacity: 0; transform: translateY(10px); } to { opacity: 1; transform: translateY(0); } }
        .lesson-card { background: var(--bg-secondary); border: 1px solid var(--border-color); border-radius: 16px; padding: 2rem; margin-bottom: 2rem; width: 100%; max-width: 100%; overflow: hidden; }
        .lesson-card h2 { font-family: var(--font-display); font-size: 1.5rem; color: var(--text-primary); margin-bottom: 1.25rem; word-wrap: break-word; }
        .lesson-card h3 { font-size: 1.1rem; color: var(--text-primary); margin: 1.5rem 0 0.75rem; font-weight: 600; word-wrap: break-word; }
        .lesson-card p { color: var(--text-secondary); margin-bottom: 1rem; line-height: 1.8; word-wrap: break-word; overflow-wrap: break-word; }
        ...
        .table-wrapper { width: 100%; overflow-x: auto; -webkit-overflow-scrolling: touch; margin: 1.5rem 0; max-width: 100%; display: block; }
        .comparison-table { width: 100%; border-collapse: collapse; font-size: 0.9rem; min-width: 500px; table-layout: auto; }
        ...
        .quiz-section { background: var(--bg-secondary); border: 1px solid var(--border-color); border-radius: 16px; padding: 2rem; margin-bottom: 2rem; width: 100%; max-width: 100%; overflow: hidden; }
        ...
        @media (max-width: 768px) {
            ...
            .header-content { justify-content: center; text-align: center; flex-direction: column; gap: 0.5rem; }
            ...
            .exam-weight { gap: 1rem; padding: 0.5rem 1rem; flex-wrap: wrap; justify-content: center; }
            .weight-value { font-size: 1rem; }
            .weight-label { font-size: 0.6rem; }
            .topic-nav { padding: 0; }
            .topic-tabs { justify-content: flex-start; padding: 0 0.5rem; gap: 0; }
            .topic-tab { padding: 0.75rem 0.5rem; font-size: 0.7rem; }
            main { padding: 1rem 0.75rem 3rem; }
            .lesson-card { padding: 1rem; border-radius: 12px; margin-bottom: 1rem; }
            .lesson-card h2 { font-size: 1.25rem; margin-bottom: 1rem; }
            .lesson-card h3 { font-size: 1rem; margin: 1.25rem 0 0.5rem; }
            .lesson-card p { font-size: 0.9rem; line-height: 1.6; margin-bottom: 0.75rem; }
            .lesson-card ul, .lesson-card ol { margin: 0.75rem 0 0.75rem 1.25rem; font-size: 0.9rem; }
            .lesson-card li { margin-bottom: 0.4rem; line-height: 1.5; }
            .clinical-pearl, .red-flag, .exam-tip { padding: 1rem; margin: 1rem 0; border-radius: 0 8px 8px 0; }
            .clinical-pearl-title, .red-flag-title, .exam-tip-title { font-size: 0.8rem; margin-bottom: 0.4rem; }
            .clinical-pearl-title svg, .red-flag-title svg, .exam-tip-title svg { width: 16px; height: 16px; }
            .clinical-pearl p, .red-flag p, .exam-tip p { font-size: 0.85rem; line-height: 1.5; }
            .table-wrapper { margin: 1rem 0; padding: 0; width: 100%; max-width: 100%; }
            .comparison-table { font-size: 0.75rem; min-width: 400px; }
            .comparison-table th { padding: 0.6rem 0.5rem; font-size: 0.7rem; }
            .comparison-table td { padding: 0.6rem 0.5rem; font-size: 0.75rem; line-height: 1.4; }
            .quiz-section { padding: 1rem; border-radius: 12px; margin-bottom: 1rem; }
            .quiz-header { margin-bottom: 1rem; }
            .quiz-title { font-size: 1.1rem; }
            .quiz-progress { font-size: 0.75rem; }
            .question { padding: 1rem; margin-bottom: 1rem; border-radius: 10px; }
            .question-text { font-size: 0.9rem; margin-bottom: 0.75rem; line-height: 1.5; }
            .case-stem { padding: 0.75rem; margin-bottom: 1rem; font-size: 0.85rem; line-height: 1.5; border-radius: 6px; }
            .options { gap: 0.5rem; }
            .option { padding: 0.75rem; border-radius: 8px; gap: 0.5rem; }
            .option-radio { width: 18px; height: 18px; }
            .option.selected .option-radio::after, .option.correct .option-radio::after { width: 10px; height: 10px; }
            .option-text { font-size: 0.85rem; line-height: 1.4; }
            .feedback { padding: 0.75rem; font-size: 0.85rem; margin-top: 0.75rem; }
            .quiz-results { padding: 1.5rem 1rem; }
            .results-icon { width: 50px; height: 50px; }
            .results-icon svg { width: 24px; height: 24px; }
            .results-title { font-size: 1.25rem; }
            .results-score { font-size: 0.95rem; }
            .quiz-actions { gap: 0.5rem; margin-top: 1rem; }
            .btn { padding: 0.75rem 1rem; font-size: 0.85rem; border-radius: 8px; }
            .btn svg { width: 16px; height: 16px; }
            .nav-buttons { flex-direction: column; margin-top: 1.5rem; padding-top: 1.5rem; gap: 0.75rem; }
            .nav-buttons .btn { width: 100%; justify-content: center; }
        }
        @media (max-width: 480px) {
            .header { padding: 0.5rem 0.75rem; }
            .back-link span { display: none; }
            .topic-tab { padding: 0.6rem 0.4rem; font-size: 0.65rem; }
            main { padding: 0.75rem 0.5rem 2rem; }
            .lesson-card { padding: 0.875rem; }
            .lesson-card h2 { font-size: 1.1rem; }
            .lesson-card h3 { font-size: 0.95rem; }
            .lesson-card p, .lesson-card li { font-size: 0.85rem; }
            .comparison-table { min-width: 350px; }
            .comparison-table th, .comparison-table td { padding: 0.5rem 0.4rem; font-size: 0.7rem; }
            .question { padding: 0.875rem; }
            .question-text { font-size: 0.85rem; }
            .case-stem { font-size: 0.8rem; padding: 0.6rem; }
            .option { padding: 0.6rem; }
