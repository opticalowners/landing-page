class CourseModule1 extends HTMLElement {
                        ...
                        <div class="quiz-section">
                            ...
                            <div class="hidden" id="finalQuizContent">
                                ...
                                <div class="quiz-actions">
                                    ...
                                    <a href="https://www.opticalowners.com/sales-modules" class="btn btn-primary hidden" id="nextModule">Back to Training <svg viewBox="0 0 24 24"><path d="M12 4l-1.41 1.41L16.17 11H4v2h12.17l-5.58 5.59L12 20l8-8z"/></svg></a>
                                </div>
                            </div>
                        </div>
                        <div class="nav-buttons">
    ...
    initializeComponent() {
        ...
        function showTopic(id) {
            shadow.querySelectorAll('.topic-content').forEach(function(t) { t.classList.remove('active'); });
            shadow.querySelectorAll('.topic-tab').forEach(function(t) { t.classList.remove('active'); });
        ...
        shadow.querySelectorAll('.topic-tab').forEach(function(tab) {
            tab.addEventListener('click', function() { showTopic(tab.dataset.topic); });
        });

        shadow.querySelectorAll('.next-topic').forEach(function(btn) {
            btn.addEventListener('click', function() { showTopic(btn.dataset.next); });
        });

        shadow.querySelectorAll('.prev-topic').forEach(function(btn) {
            btn.addEventListener('click', function() { showTopic(btn.dataset.prev); });
        });

        // Quiz Logic
        shadow.querySelectorAll('.quiz-section[data-quiz]').forEach(function(quiz) {
            ...
            questions.forEach(function(q) {
                q.querySelectorAll('.option').forEach(function(opt) {
                    opt.addEventListener('click', function() {
                        ...
                        q.querySelectorAll('.option').forEach(function(o) { o.classList.remove('selected'); });
            ...
            retryBtn.addEventListener('click', function() {
                questions.forEach(function(q) {
                    ...
                    q.querySelectorAll('.option').forEach(function(o) { o.classList.remove('selected', 'correct', 'incorrect'); });
