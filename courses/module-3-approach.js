        ...
        return '<div class="topic-content" id="topic-final">' +
            '<div class="quiz-section">' +
                ...
                '<div class="hidden" id="finalQuizContent">' +
                    ...
                    '<div class="quiz-actions"><button class="btn btn-primary" id="submitFinalQuiz">Submit Final Quiz</button><button class="btn btn-secondary hidden" id="retryFinalQuiz">Try Again</button><a href="https://www.opticalowners.com/training" class="btn btn-primary hidden" id="nextModule">Back to Training ' + arrowRight + '</a></div>' +
                '</div>' +
            '</div>' +
